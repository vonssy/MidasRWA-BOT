...
> Automated interact with telegram mini app and multi-account management

[![Python Version](https://img.shields.io/badge/python-3.9+-blue.svg)](https://www.python.org/downloads/)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/vonssy/MidasRWA-BOT.svg)](https://github.com/vonssy/MidasRWA-BOT/stargazers)
...
Midas RWA BOT is an automated tool designed to interact with telegram mini app across multiple accounts. It provides seamless offers robust proxy support for enhanced security and reliability.

**🔗 Get Started:** [Register on Midas RWA](https://t.me/MidasRWA_bot/app?startapp=ref_b6243c03-25ae-43f0-9667-5defd6c43b9b)  

> **Important:** Not Support in Termux
...
- 🎁 **Claim Referral Rewards** - Automated claim referral rewards
- 🎮 **Play Tap Tap Games** - Automated playing tap tap game
...
Create or edit `query.txt` in the project directory:
...
- **Developer:** vonssy
- **Issues:** [GitHub Issues](https://github.com/vonssy/MidasRWA-BOT/issues)
- **Discussions:** [GitHub Discussions](https://github.com/vonssy/MidasRWA-BOT/discussions)
...
*Thank you for using Midas RWA BOT! Don't forget to ⭐ star this repository.*
